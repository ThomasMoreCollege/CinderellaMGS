...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <table id="AltMangTable" style="width:60%;">
        ...
        <tr id="middleRow">
            <td class="auto-style7">
                <asp:Button ID="DressReadyButton" runat="server" Text="Mark Dress as Ready" Height="31px" Width="140px" PostBackUrl="~/Forms/UserForms/ChildForms/PackageCheckout.aspx"/>
            </td>
