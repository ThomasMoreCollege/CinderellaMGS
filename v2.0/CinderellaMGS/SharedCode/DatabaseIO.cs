...
namespace CinderellaMGS
{
    ...
    {
        //Instantiate the ModifyRegistry class so the connection string can be written to registry
        ...
        public bool checkConnection()
        {
            try
            {
                ...
                conn = new SqlConnection(RetrieveConnectionString());
                conn.Open();
                return true;
            }
            catch (Exception ex)
        ...
        public SqlConnection GetConnection()
        {
            ...
            {
                var result = MessageBox.Show("There has been an error establishing a connection with the server. Would you like to enter new connection settings?", "Connection Could Not Be Established",
        ...
        {
            MessageBox.Show(errorMessage.ToString(), "Datbase Error",MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        /// <summary>
        ...
        public string getAggDataString(string sqlComm, string tableName)
        {
            ...
            {
                CloseConnection();
                SqlConnection sqlconn = new SqlConnection(RetrieveConnectionString());
                sqlconn.Open();
